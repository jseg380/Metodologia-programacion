...
public:
	...
	void LeerMatriz2D (const string & nombre);
	...
	void EscribirMatriz2D (const string & nombre) const;
...
private:
	...
	bool FicheroMatriz2DCorrecto (const string & nombre);
