...
Matriz2D :: Matriz2D (int nfils, int ncols, TipoBaseMatriz2D valor)
{
	...
	// Inicializa los valores a valor
...
TipoBaseMatriz2D & Matriz2D :: Elemento (int fila, int columna)
{
	return el_elemento (fila, columna);
}

TipoBaseMatriz2D & Matriz2D :: Elemento (int fila, int columna) const
{
	return el_elemento (fila, columna);
}
...
{
	bool filas_iguales = (fils == otra.fils);
	bool columnas_iguales = (cols == otra.cols);
	bool iguales = (filas_iguales && columnas_iguales);
